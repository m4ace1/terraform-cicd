...
const Patron = () => {
	return (
		<div
			className='w-full md:px-[120px] px-4 pt -[50px] md:min-h-screen flex flex-col justify-center '
			id='patrons'
		>
			<div className=''>
			...
			<div className='flex flex-col md:flex-row flex-wrap items-center md:items-start md:justify-between gap-y-8 h-full'>
